...
class TestAbsoluteLinearMomentum:
    ...
    def test_absolute_linear_momentum_exists(self) -> None:
        a = TimeStep(
            Absolute_linear_momentum=self.Absolute_linear_momentum,
            Time=8.190e-05,
            Current_number_of_parcels=6380,
            Current_mass_in_system=4.23525746e-22,
            Linear_kinetic_energy=2.41789442e-16,
    ...
    def test_absolute_linear_momentum_gt_zero():
        with pytest.raises(AssertionError):
            a = TimeStep(
                Absolute_linear_momentum=-0.001,
                Time=8.190e-05,
                Current_number_of_parcels=6380,
                Current_mass_in_system=4.23525746e-22,
                Linear_kinetic_energy=2.41789442e-16,
...
class TestLinearKineticEnergy:
    ...
    def test_Linear_kinetic_energy_exists(self):
        a = TimeStep(
            Linear_kinetic_energy=self.Linear_kinetic_energy,
            Absolute_linear_momentum=5.43242364e-20,
            Time=8.190e-05,
            Current_number_of_parcels=6380,
            Current_mass_in_system=4.23525746e-22,
